...
export const billingApi = {
  ...
  exportPdf:          (cycleId, idSmart)     => api.get(`/billing/cycles/${cycleId}/clients/${idSmart}/pdf`, { responseType: 'blob', timeout: 60000 }),
  exportClientExcel:  (cycleId, idSmart)     => api.get(`/billing/cycles/${cycleId}/clients/${idSmart}/excel`, { responseType: 'blob', timeout: 60000 }),
